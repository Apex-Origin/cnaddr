 ...
 * 地级行政区（地级市 / 地区 / 自治州 / 盟）。
 *
 * 以「省级 code」为键分组，值为该省下属的地级单位列表。
 * `code` 为 6 位国标行政区划代码（地级以 00 结尾）。
 *
 * 覆盖范围：全国 333 个地级区划（含 4 直辖市本级）。区县级未内置，
 * 如需精确到区县，请通过 setDistrictProvider 注入完整数据集。
 */
...
export const CITIES: Record<string, CityRecord[]> = {
  ...
  // 台湾省（行政区划代码采用规划编码，仅供结构化使用）
  '710000': [
    { code: '710100', name: '台北市' },
    { code: '710200', name: '高雄市' },
    { code: '710300', name: '台中市' },
    { code: '710400', name: '台南市' },
    { code: '710500', name: '新北市' },
    { code: '710600', name: '桃园市' },
  ],

  // 香港特别行政区
  '810000': [{ code: '810100', name: '香港特别行政区' }],
